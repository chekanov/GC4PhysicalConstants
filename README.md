...
If you are intrested in a more physics oriented study, where these datasets and the proposed AI techniue are applied to discover a possible theory behind many free parameters of the Standard Model, please cite the following work:
